...
function ListItemA({ movies }){
    ...
    return(
        movies?.map(m => m[2].show ?
        <div className="list-item" key={m[1][0].id}>
            <div className="item-image-container">
                {m[1][0].image ? <img src={m[1][0].image} alt={m[2]}></img> : <><img src={noImage} alt='not found'></img> <h1 style={{position: 'absolute', fontSize: '16px', marginTop: '200px'}}>Wheres image? </h1></>}        
            </div>
